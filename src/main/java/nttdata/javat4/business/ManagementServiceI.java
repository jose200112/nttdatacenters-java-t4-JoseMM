...
/**
 * Interfaz ManagementServiceI con metodos para la gestion de centros y
 * estudiantes
 * 
 * @author jose
 *
...
public interface ManagementServiceI {
	...
	/**
	 * Metodo para borrar un centro educativo Para borrar al centro primero habra
	 * que borrar los estudiantes
	 * 
	 * @param name (Nombre del centro)
	 */
